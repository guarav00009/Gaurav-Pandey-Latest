...
class _Menu:
    ...
    def admin_apps(self, context, r):
        ...
        data = [context['available_apps'][0],context['available_apps'][3],context['available_apps'][2],context['available_apps'][1]]
        for app in data:
            ...
            for model in app['models']:
                ...
                if(request.path == url):
                    r += '<li class="nav-item"><a href="%s" class="nav-link active" %s>%s %s</a></li>' % (url, css,icon, model['name'])
                else:
